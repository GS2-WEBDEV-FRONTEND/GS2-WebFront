    ...
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center px-4">
      <div className="bg-slate-950 border border-indigo-600/50 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.9)]">
        ...
        <div className="grid md:grid-cols-[minmax(0,1.6fr)_minmax(0,1.1fr)] gap-5 px-6 py-4 overflow-y-auto max-h-[78vh]">
          ...
          {/* Coluna direita: envio de mensagem */}
          <div className="space-y-3 border-t md:border-t-0 md:border-l border-slate-800 pt-4 md:pt-0 md:pl-4">
            <section>
              <h3 className="text-xs font-semibold text-slate-200 uppercase tracking-wide">
                Enviar mensagem para o profissional
              </h3>
              <p className="mt-1 text-[11px] text-slate-400">
                Use esse espaço para fazer uma pergunta, convidar para uma
                conversa ou comentar sobre as habilidades do perfil.
              </p>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-700 bg-slate-900 px-2 py-1.5 text-[11px] text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/70 focus:border-indigo-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-slate-700 bg-slate-900 px-2 py-1.5 text-[11px] text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/70 focus:border-indigo-500"
                    placeholder="Escreva aqui sua mensagem para este profissional..."
                  />
                </div>
            ...
            {/* Contatos */}
            <section className="mt-2 text-[11px] text-slate-300">
